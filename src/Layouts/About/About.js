        ...
        <div className='about-wrapper' id='about'>
            <div className='about-container'>
                ...
                <div className='description'>
                    ...
                    <p className='summary'>
                        As a Software Engineer having close to 5 years of experience in front-end development in the IT industry,I possess an impressive arsenal of skills in <b>HTML,CSS, JavaScript,React and SCSS.</b> I excel in designing and maintaining responsive websites that offer a smooth user experience. My expertise lies in crafting dynamic, engaging interfaces through writing clean and optimized code and utilizing cutting-edge development tools and techniques. I am also a team player who thrives in collaborating with cross-functional teams to produce outstanding web applications.
                    </p>
                </div>
            </div>
        </div>
